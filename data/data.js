export const rooms = [
  {
    id: 1,
    title:
      "[Nouvelle ouverture] Marita m01, juste en face de la plage, près de la pension de couple, village calme, Gwakji, Hyeopjae",
  ...
  {
    id: 2,
    title: "Hébergement sensationnel à Jeju Mini Mary [Chambre Mini Mary:]",
    property_type: "maison entière",
    max_capacity: 4,
    bedrooms: 1,
    beds: 3,
  ...
  {
    id: 3,
    title: "[High Residence] Studio nouvellement construit près de l'aéroport dans le centre de Shinjeju (Standard)",
    property_type: "maison entière",
    max_capacity: 3,
    bedrooms: 1,
    beds: 2,
  ...
  {
    id: 4,
    title: "Maison au milieu d'un champ de mandarine, Tangerine Hanga Room 202",
    property_type: "maison entière",
    max_capacity: 2,
    bedrooms: 1,
    beds: 2,
  ...
  {
    id: 5,
    title: "Ju's home(2) Aéroport 9km/ Logement émotionnel au 2ème étage face à la plage de la ville de Jeju",
    property_type: "maison entière",
    max_capacity: 4,
    bedrooms: 1,
    beds: 4,
